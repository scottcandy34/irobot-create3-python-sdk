...
class SubscriptionInterface(MsgCallbacks, Threading if TYPE_CHECKING else object):
    ...
    def __init__(self, node):
        ...
        # Create Subscription
        self._scan = self.node.create_subscription(LaserScan, 'scan', self._scan_callback, sub_qos_profile, callback_group=subscription_callback_group)
        self._range = self.node.create_subscription(Range, 'range', self._range_callback, sub_qos_profile, callback_group=subscription_callback_group)
